...
public class Lec01DefaultBuffer {
    ...
    public static void main(String[] args) {
        ...
        /*
        if the publisher is faster than the consumer and it produces a huge amount of items,
        the system for default (BUFFER strategy) has to keep in the memory what was produced
        until the subscriber will consume it.
        N.B. It is never good to keep too much data in the memory
        */
